...
- If the task is a general admin, organizational, or non-song task → use type "Org Task" and status "General"
- If the task is specifically about a song, album, or EP → use type "Song"/"Album"/"EP" and status "Pre-Production"
